 ...
 * $Revision: 6 $
 * $Date: 16/10/25 4:25p $
 * @brief    NUC1261 series ADC driver source file
 *
 * @note
 *
...
/**
  ...
  * @return  None
  * @note NUC1261 series MCU ADC can only convert 1 channel at a time. If more than 1 channels are enabled, only channel
